...
},{"./caml_builtin_exceptions.js":7}],4:[function(require,module,exports) {
'use strict';
...
},{"./caml_builtin_exceptions.js":7}],8:[function(require,module,exports) {
'use strict';
...
},{"./caml_array.js":16}],5:[function(require,module,exports) {
'use strict';
...
},{"bs-platform/lib/js/curry.js":8,"bs-platform/lib/js/caml_builtin_exceptions.js":7}],20:[function(require,module,exports) {
...
},{"./curry.js":8,"./caml_builtin_exceptions.js":7,"process":20}],10:[function(require,module,exports) {
var process = require("process");
'use strict';
...
},{"./caml_builtin_exceptions.js":7,"process":20}],18:[function(require,module,exports) {
'use strict';
...
},{"./caml_int32.js":4,"./caml_utils.js":18,"./caml_primitive.js":21,"./caml_builtin_exceptions.js":7}],11:[function(require,module,exports) {
'use strict';
...
},{"./curry.js":8,"./caml_int32.js":4,"./caml_int64.js":17,"./caml_utils.js":18,"./caml_builtin_exceptions.js":7}],12:[function(require,module,exports) {
'use strict';
...
},{"./block.js":19}],6:[function(require,module,exports) {
'use strict';
...
},{"./curry.js":8,"./caml_io.js":9,"./caml_sys.js":10,"./caml_format.js":11,"./caml_string.js":12,"./caml_exceptions.js":13,"./caml_missing_polyfill.js":14,"./caml_builtin_exceptions.js":7,"./camlinternalFormatBasics.js":15}],3:[function(require,module,exports) {
module.exports="/frogger_sprites.e7457bc6.png";
...
var frogSprites = /* record */[frogSprites_000, frogSprites_001, frogSprites_002, frogSprites_003];
...
/* width */35,
/* height */30,
/* frameIndex */0, frogSprites_000];

var startWorld = /* record */[startWorld_000,
/* width */400,
/* height */440,
/* keys */pressedKeys,
/* cars : [] */0];
...
function updateCars(cars, dt) {
  if (cars) {
    return (/* :: */[updateCar(cars[0], dt), updateCars(cars[1], dt)]
    );
  } else {
    return (/* [] */0
    );
...
var lastRowProbabilities = /* array */[0, 3, 2];
...
function update(ctx, world) {
  ...
  var frog_000 = /* x */world[/* frog */0][/* x */0] + 42 * (pressedKeys[/* left */0] ? -1 : pressedKeys[/* right */1] ? 1 : 0);
  var frog_001 = /* y */world[/* frog */0][/* y */1] + 30 * (pressedKeys[/* up */2] ? -1 : pressedKeys[/* down */3] ? 1 : 0);
  ...
  var frog_005 = /* currentSprite */pressedKeys[/* up */2] ? frogSprites_000 : pressedKeys[/* down */3] ? frogSprites_001 : pressedKeys[/* left */0] ? frogSprites_002 : pressedKeys[/* right */1] ? frogSprites_003 : world[/* frog */0][/* currentSprite */5];
  var frog = /* record */[frog_000, frog_001, frog_002, frog_003, frog_004, frog_005];
  var movedCars = updateCars(world[/* cars */4], dt);
  var cars = now - lastCarTime[0] > 5000 ? /* :: */[makeCar(1, yellowCarImage),
  /* :: */[makeCar(2, greenCarImage), movedCars]] : movedCars;
  ...
  var newWorld = /* record */[
  /* frog */frog, newWorld_001, newWorld_002, newWorld_003,
  /* cars */cars];
...
exports.load = load;
/*  Not a pure module */
},{"bs-platform/lib/js/caml_array.js":16,"bs-platform/lib/js/caml_int32.js":4,"bs-webapi/src/canvas/Canvas2dRe.js":5,"bs-platform/lib/js/pervasives.js":6,"../assets/frogger_sprites.png":3}],54:[function(require,module,exports) {
...
//# sourceMappingURL=/index.bs.f5ea81cc.map